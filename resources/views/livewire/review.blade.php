                ...
                <div class="form-group">
                    ...
                    <fieldset>
                        <span class="star-cb-group">
                          <input type="radio" wire:model="rate" id="rating-5" name="rating" value="5" />
                          <label for="rating-5">5</label>
                          <input type="radio" wire:model="rate" id="rating-4" name="rating" value="4" />
                          <label for="rating-4">4</label>
                          <input type="radio" wire:model="rate" id="rating-3" name="rating" value="3" />
                          <label for="rating-3">3</label>
                          <input type="radio" wire:model="rate" id="rating-2" name="rating" value="2" />
                          <label for="rating-2">2</label>
                          <input type="radio" wire:model="rate" id="rating-1" name="rating" value="1" />
                          <label for="rating-1">1</label>
                          <input type="radio" wire:model="rate" id="rating-0" name="rating" value="0" class="star-cb-clear" />
