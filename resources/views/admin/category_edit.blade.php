...
@section('title', $setting->title.'-'.$data->title)
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <div class="form-body mt-4">
                <div class="row">
                    <form action="{{route('admin_category_update', ['id'=>$data->id])}}" role="form" id="quickForm" method="Post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12">
